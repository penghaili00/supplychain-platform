...
-- Flyway migration V1__init_schema.sql is now the authoritative schema source.
...
INSERT INTO `app_user` (`id`, `username`, `password_hash`, `password_salt`, `display_name`, `status`, `created_by`, `updated_by`, `deleted`) VALUES
(2001, 'demo', '/Aau8JFf63ZAAyaS7oaqEuP5IN/GbnCy48oC76mKNlY=', 'bXBIFnmlxK3G5KJMYFYmeA==', 'SupplyChain演示用户', 1, 'system', 'system', 0);
